...
class LineAPI(object):
    ...
    # LINE_HTTP_IN_URL       = "http://gfp.line.naver.jp/P3"
    # LINE_HTTP_URL       = LINE_HTTP_IN_URL
    ...
    def _kickoutFromGroup(self, reqSeq, groupId, contactIds):
        return self._client.kickoutFromGroup(reqSeq, groupId, contactIds)
